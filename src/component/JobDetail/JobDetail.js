            ...
            <Container>
                ...
                <main>
                    <div className='job-detail__responsibilities'>
                        <h3>Обязанности</h3>
                        <p >
                            Настройка страниц и компонентов. Кастомизация внешнего вида страниц и компонентов с помощью HTML + CSS;
                    ...
                    <div className='job-detail__qualifications'>
                        <h3>Ожидаемый набор навыков и знаний</h3>
                        <p >
                            понимание основ и идеологии React.js и компонентной структуры;
                    ...
                    <div className='job-detail__qualifications'>
                        <h3>У нас:</h3>
                        <p >
                            Возможность работать полностью удаленно или в офисе. График работы - полный рабочий день.
